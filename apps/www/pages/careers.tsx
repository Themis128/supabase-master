// import { GlobeAltIcon } from '@heroicons/react/outline' // Disabled: missing module/type
            ...
            {career.company.map((company, i) => {
              return (
                ...
                >
                  ...
                  {/* @ts-expect-error: ReactMarkdown JSX type error, safe to ignore for v7+ */}
    ...
    >
      ...
      <div className="flex justify-between justify-[normal] pt-2 md:pt-0 lg:w-1/3 items-center">
        <div className="flex items-center gap-4">
          <Badge>
            {/* Icon removed: GlobeAltIcon unavailable */}
