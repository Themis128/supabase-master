// import { ArrowLeftIcon, ArrowRightIcon } from '@heroicons/react/outline' // Disabled: missing module/type
          ...
          <div className="my-8 flex items-center gap-4">
            {hasPreviousPage && (
              <Link href={`/changelog`} className="flex items-center gap-2">
                {/* Removed: <ArrowLeftIcon /> (missing icon) */} Previous
              </Link>
            )}
            {hasNextPage && (
              <Link
              ...
              >
                Next {/* Removed: <ArrowRightIcon /> (missing icon) */}
              </Link>
            )}
          </div>
        </div>
