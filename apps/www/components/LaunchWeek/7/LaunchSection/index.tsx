...
// import { PlayIcon, TruckIcon, XIcon } from '@heroicons/react/outline' // Disabled: missing module/type
        ...
        {props.shipped ? (
          <Badge>
            <div className="flex items-center gap-2">
              <div className="w-4">
                {/* Removed: <TruckIcon /> (missing icon) */}
              </div>{' '}
              Shipped
            </div>
          </Badge>
