  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Link
        ...
        target="_blank"
        className={cn(
          'opacity-0 outline-none group translate-x-2 !ease-&lsqb;.24,0,.22,.99&rsqb; duration-200 transition-all text-foreground-muted hover:text-foreground !leading-3 font-mono uppercase text-[10px] flex flex-col text-right',
