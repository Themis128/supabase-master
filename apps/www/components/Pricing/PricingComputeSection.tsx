...
// import { ChevronDownIcon } from '@heroicons/react/outline' // Disabled: missing module/type
  ...
  return (
    <Panel outerClassName="w-full mx-auto max-w-6xl" innerClassName="flex flex-col">
      ...
      <div className="flex flex-col">
        <div
          className="relative w-full overflow-hidden transition-all !ease-&lsqb;.76,0,.23,1&rsqb; duration-300"
        ...
        >
          {/* Removed: <ChevronDownIcon /> (missing icon) */}
