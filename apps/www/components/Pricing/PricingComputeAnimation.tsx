  ...
  return (
    ...
    >
      <Image
        ...
        className={cn(
          'absolute inset-0 z-20 transition-opacity opacity-0 !ease-&lsqb;.76,0,.23,1&rsqb; duration-300',
      ...
      <Image
        ...
        alt="Compute addon grid"
        className={cn(
          'absolute inset-0 z-20 transition-all opacity-0 !ease-&lsqb;.76,0,.23,1&rsqb; duration-500 delay-500 -translate-y-[18%] blur-md',
      ...
      <Image
        ...
        alt="Compute addon grid"
        className={cn(
          'absolute inset-0 z-20 transition-all opacity-0 !ease-&lsqb;.76,0,.23,1&rsqb; duration-500 delay-1000 -translate-y-[24%] blur-md',
