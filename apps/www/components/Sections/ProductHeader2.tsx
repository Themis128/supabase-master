...
const ProductHeader = (props: Props) => {
  if (!props || typeof props.h1 !== 'string') {
    console.warn('ProductHeader: props or h1 is missing or not a string.', props)
    return null
  }
  return (
    <div
    ...
    >
      <SectionContainer className={cn('!py-0 grid grid-cols-12', props.sectionContainerClassName)}>
        <div className="relative z-10 col-span-12 gap-8 lg:col-span-5">
          ...
          {Array.isArray(props.subheader) && props.subheader.length > 0 && (
